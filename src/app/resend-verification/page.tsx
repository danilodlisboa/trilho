    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl glass-panel space-y-6">
        ...
        <div className="text-center space-y-1">
          <h1 className="text-xl font-bold text-white">Resend Verification Email</h1>
          <p className="text-xs text-slate-400">Enter your email to receive a new account activation link.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Send Verification Link'}
          </button>
        </form>
